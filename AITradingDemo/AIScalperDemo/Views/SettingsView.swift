        ...
        ZStack {
            ...
            Form {
                ...
                Section("Position") {
                    ...
                    if engine.marketMode == .live {
                        Label("Entry uses the visible provider quote; estimated trading costs are deducted separately", systemImage: "checkmark.circle.fill")
                            .font(.caption)
                            .foregroundStyle(.secondary)
                    } else {
