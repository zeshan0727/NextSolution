...
struct TransactionRow: View {
    ...
    private var secondaryText: String {
        if transaction.vendor?.isEmpty == false { return transaction.category }
        return transaction.details.isEmpty ? DisplayFormat.day.string(from: transaction.date) : transaction.category
    }
}
