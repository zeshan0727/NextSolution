...
echo "Building iOS 16 session exporter..."
rm -rf build package NextMultiBrowser_iOS16_SessionExporter.tipa NextMultiBrowser_iOS16_SessionExporter.ipa
set -o pipefail
xcodebuild \
...
(
  cd package
  /usr/bin/zip -qry ../NextMultiBrowser_iOS16_SessionExporter.tipa Payload
)
cp NextMultiBrowser_iOS16_SessionExporter.tipa NextMultiBrowser_iOS16_SessionExporter.ipa

echo
echo "Build completed:"
ls -lh NextMultiBrowser_iOS16_SessionExporter.tipa NextMultiBrowser_iOS16_SessionExporter.ipa
echo
echo "SHA-256:"
shasum -a 256 NextMultiBrowser_iOS16_SessionExporter.tipa NextMultiBrowser_iOS16_SessionExporter.ipa
