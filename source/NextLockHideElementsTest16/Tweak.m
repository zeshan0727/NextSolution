...
__attribute__((used)) static const char *NLHideMarker =
    "NextLockHideElements 1.1.5-test16 native-system-time-date-hooks";
...
static __weak UIView *NLNativeTimeView = nil;
...
static void (*NLOrigNativeTimeLayout)(UIView *, SEL) = NULL;
...
#pragma mark - Native Apple Time / Date (iOS 16)
...
static void NLApplyStateBoundViews(void) {
    ...
    NLSetSuppressed(NLNativeTimeView, NLHideTime);
...
__attribute__((constructor)) static void NLHideInit(void) {
    @autoreleasepool {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            // Native Apple iOS 16 clock/date. Designer's combined hide uses
            ...
            NLApplyStateBoundViews();
            NSLog(@"[NextLockHideElements] Test16 loaded: native Apple time/date + Designer direct hooks active");
        });
    }
}
